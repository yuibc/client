    ...
    <section>
      <div className="flex flex-col items-center mb-6">
        <span className="my-7 flex flex-row gap-2">
          ...
          <h1 className="text-5xl font-bold">Creators of the month</h1>
        </span>
        <div className="flex justify-center items-center gap-3">
          <CreatorBlock displayName="@User_Name_123" followerCount={10000} />
          <CreatorBlock displayName="@User_Name_123" followerCount={6000} />
          <CreatorBlock displayName="@User_Name_123" followerCount={4000} />
        </div>
      </div>
