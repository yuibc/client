...
export const WalletLoginIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const GgTrendingIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
    ...
    return (
        <svg
            ...
            <path
                fill="#a889ff"
                d="M1.414 16.432L0 15.018l7.071-7.071l6.364 6.364l4.243-4.243l-1.743-1.742l6.692-1.793l-1.793 6.692l-1.742-1.742l-5.657 5.656l-6.364-6.364z"></path>
        </svg>
    );
};

export const MdiCreationIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
    ...
    return (
        <svg
            ...
            <path
                fill="#a889ff"
                d="m19 1l-1.26 2.75L15 5l2.74 1.26L19 9l1.25-2.74L23 5l-2.75-1.25M9 4L6.5 9.5L1 12l5.5 2.5L9 20l2.5-5.5L17 12l-5.5-2.5M19 15l-1.26 2.74L15 19l2.74 1.25L19 23l1.25-2.75L23 19l-2.75-1.26"></path>
        </svg>
    );
};

export const IcBaselineEmailIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const MingcuteUserFollowFillIcon: React.FC<IconSvgProps> = ({
    size = 36,
    width,
    height,
    ...props
...
export const FluentFilter24FilledIcon: React.FC<IconSvgProps> = ({
    ...
    return (
        <svg
            ...
            <path
                fill="#a889ff"
                d="M10 16h4a1 1 0 0 1 .117 1.993L14 18h-4a1 1 0 0 1-.117-1.993zh4zm-2-5h8a1 1 0 0 1 .117 1.993L16 13H8a1 1 0 0 1-.117-1.993zh8zM5 6h14a1 1 0 0 1 .117 1.993L19 8H5a1 1 0 0 1-.117-1.993zh14z"></path>
        </svg>
    );
};
...
export const MingcuteUserStarFillIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
    ...
    return (
        <svg
            ...
            <g fill="none" fillRule="evenodd">
                ...
                <path
                    fill="#a889ff"
                    d="M11 2a5 5 0 1 0 0 10a5 5 0 0 0 0-10m0 11c-2.395 0-4.575.694-6.178 1.672c-.8.488-1.484 1.064-1.978 1.69C2.358 16.976 2 17.713 2 18.5c0 .845.411 1.511 1.003 1.986c.56.45 1.299.748 2.084.956C6.665 21.859 8.771 22 11 22c.23 0 .46-.002.685-.005a1 1 0 0 0 .89-1.428A5.973 5.973 0 0 1 12 18c0-1.252.383-2.412 1.037-3.373a1 1 0 0 0-.72-1.557c-.43-.046-.87-.07-1.317-.07m7.864.997a1 1 0 0 0-1.728 0l-.91 1.562l-1.766.382a1 1 0 0 0-.534 1.644l1.204 1.348l-.182 1.798a1 1 0 0 0 1.398 1.016l1.654-.73l1.654.73a1 1 0 0 0 1.398-1.016l-.182-1.799l1.204-1.347a1 1 0 0 0-.534-1.644l-1.766-.382z"></path>
            </g>
        </svg>
    );
};

export const FaSolidUsersIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const ArcticonsPhantomBlackIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
    ...
    return (
        <svg
            ...
            <path
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M39.857 21.357V42.5c-4.945-5.039-10.912-5.039-15.857 0c-4.945-5.039-10.912-5.039-15.857 0V21.357C9.458.214 38.53.214 39.857 21.357"></path>
            <path
                fill="none"
                stroke="#a889ff"
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M17.399 17.399c2.185 0 3.958 1.773 3.958 3.958s-1.774 3.97-3.958 3.97c-2.197 0-3.97-1.785-3.97-3.97s1.773-3.958 3.97-3.958m13.214 0c2.185 0 3.958 1.773 3.958 3.958s-1.773 3.97-3.958 3.97c-2.197 0-3.97-1.785-3.97-3.97s1.773-3.958 3.97-3.958"></path>
        </svg>
    );
};

export const FlatColorIconsGoogle: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const SolarTrashBinTrashBoldIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const PhGearSixFillIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
    ...
    return (
        <svg
            ...
            <path
                fill="#a889ff"
                d="M237.94 107.21a8 8 0 0 0-3.89-5.4l-29.83-17l-.12-33.62a8 8 0 0 0-2.83-6.08a111.91 111.91 0 0 0-36.72-20.67a8 8 0 0 0-6.46.59L128 41.85L97.88 25a8 8 0 0 0-6.47-.6a111.92 111.92 0 0 0-36.68 20.75a8 8 0 0 0-2.83 6.07l-.15 33.65l-29.83 17a8 8 0 0 0-3.89 5.4a106.47 106.47 0 0 0 0 41.56a8 8 0 0 0 3.89 5.4l29.83 17l.12 33.63a8 8 0 0 0 2.83 6.08a111.91 111.91 0 0 0 36.72 20.67a8 8 0 0 0 6.46-.59L128 214.15L158.12 231a7.91 7.91 0 0 0 3.9 1a8.09 8.09 0 0 0 2.57-.42a112.1 112.1 0 0 0 36.68-20.73a8 8 0 0 0 2.83-6.07l.15-33.65l29.83-17a8 8 0 0 0 3.89-5.4a106.47 106.47 0 0 0-.03-41.52M128 168a40 40 0 1 1 40-40a40 40 0 0 1-40 40"></path>
        </svg>
    );
};

export const TablerMoodEmptyFilledIcon: React.FC<IconSvgProps> = ({
    size = 36,
    width,
    height,
    ...props
