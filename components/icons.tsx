...
export const WalletLoginIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const GgTrendingIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const MdiCreationIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
export const IcBaselineEmailIcon: React.FC<IconSvgProps> = (props) => {
  const { width, height = 40 } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
